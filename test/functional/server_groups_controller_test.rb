...
=end
  ...
  test "should create server_group with server and client" do
    ...
    assert_difference('ServerGroup.count') do
      post :create, :server_group => { :name => "test1", :owner_name => "dan.prince", :domain_name => "test.rsapps.net", :description => "test1", :servers_attributes => {"0" => { :name => "test1", :description => "test description", :flavor_id => 1, :image_id => 1 }}, :client_attributes => {"0" => {:name => "test2", :description => "blah blah"}} }
    end
    end
    assert_response :success
  ...
  test "should create server_group with image uuid" do
    ...
    assert_difference('Server.count') do
    assert_difference('ServerGroup.count') do
      post :create, :server_group => { :name => "test1", :owner_name => "dan.prince", :domain_name => "test.rsapps.net", :description => "test1", :servers_attributes => {"0" => { :name => "test1", :description => "test description", :flavor_id => "2", :image_id => image_id }}, :client_attributes => {"0" => {:name => "test2", :description => "blah blah"}} }
    end
    end
    assert_response :success
  ...
  test "should create server_group" do
    http_basic_authorize
    assert_difference('ServerGroup.count') do
      post :create, :server_group => { :name => "test1", :owner_name => "dan.prince", :domain_name => "test.rsapps.net", :description => "test1" }
    end
    assert_response :success
  ...
  test "should create server_group via XML request with image name" do
    ...
    assert_difference('SshPublicKey.count') do
          assert_difference('Server.count') do
            assert_difference('ServerGroup.count') do
                  ...
                  @request.env['RAW_POST_DATA'] = get_xml_request_with_image_name('Test')
...
@request.env.delete('RAW_POST_DATA')
  ...
  test "groups cannot have multiple gateway servers via JSON request" do
...
<server-group>
  ...
  def get_xml_request_with_image_name(image_name)
return %{
<server-group>
  <name>Group 1</name>
  <description>Group 1 Description</description>
